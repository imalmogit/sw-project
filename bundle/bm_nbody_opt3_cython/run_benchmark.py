...
from nbody_core import advance_c
...
def advance(dt, n, bodies=SYSTEM, pairs=PAIRS):
    # The whole integration loop runs in the compiled Cython core on C
    # doubles. report_energy() and offset_momentum() stay in Python.
    advance_c(dt, n, bodies)
...
if __name__ == '__main__':
    ...
    runner.bench_time_func('nbody_opt3_cython', bench_nbody,
